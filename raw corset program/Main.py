#!/Library/Frameworks/Python.framework/Versions/epd-7.0.2
...
Simulate(inputpath,outputpath) # Model execution: to switch off preceed with '#'
Outputs(inputpath,outputpath)  # Output/visualization processing: to switch off preceed with '#'
